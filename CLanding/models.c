...
LandingConfiguration landing_configuration_default(void){
    ...
    copystr(c.vehicle.model_id,sizeof(c.vehicle.model_id),"STS-N");c.vehicle.estimated_lift_to_drag=.4;c.vehicle.estimated_ballistic_coefficient=700;c.vehicle.entry_angle_of_attack=18;c.vehicle.maximum_angle_of_attack=28;c.vehicle.maximum_bank_angle=70;c.vehicle.maximum_dynamic_pressure=45000;c.vehicle.maximum_g_load=3.5;c.vehicle.minimum_safe_speed=85;c.vehicle.final_approach_speed=115;c.vehicle.touchdown_speed=75;c.vehicle.allow_powered_approach=false;c.vehicle.maximum_approach_throttle=0;c.vehicle.airbrake_action_group=1;
    GuidanceSettings *g=&c.guidance;g->target_deorbit_capture_radius=100000;g->entry_interface_altitude_margin=500;g->target_entry_range=1030000;g->target_entry_flight_path_angle=-2.0;g->maximum_entry_flight_path_angle=-3.0;g->target_post_burn_periapsis_altitude=50000;g->deorbit_maximum_throttle=.18;g->deorbit_throttle_ramp_duration=12;g->deorbit_timing_uncertainty=.5;g->deorbit_thrust_uncertainty_fraction=.08;g->deorbit_delta_v_uncertainty=.5;g->deorbit_mass_uncertainty_fraction=.03;g->deorbit_position_uncertainty=50;g->deorbit_velocity_uncertainty=.5;g->deorbit_pointing_uncertainty=2;g->deorbit_atmosphere_uncertainty_fraction=.12;g->deorbit_robust_minimum_pass_fraction=.75;g->taem_interface_altitude=16500;g->taem_interface_range=35000;g->taem_force_handoff_speed=1300;g->mm304_handoff_radius=1000;g->mm304_perpendicular_heading_half_width=30;g->hac_radius=12000;g->hac_look_ahead_angle=16;g->final_approach_distance=8000;g->final_glide_slope=20;g->taem_glide_slope=12;g->gear_deployment_altitude=1500;g->flare_altitude=55;g->touchdown_sink_rate=-1.5;g->guidance_rate=10;g->prediction_interval=1.5;g->s_turn_minimum_leg_duration=24;g->entry_roll_rate=4.5;g->entry_roll_acceleration=1.8;g->taem_roll_rate=6;g->approach_roll_rate=3.5;g->use_time_warp=true;g->minimum_planning_lead_time=90;
