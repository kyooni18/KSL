...
Vec3 ss_v3(double x, double y, double z) { Vec3 v = {x,y,z}; return v; }
Vec3 v3_add(Vec3 a, Vec3 b) { return ss_v3(a.x+b.x, a.y+b.y, a.z+b.z); }
Vec3 v3_sub(Vec3 a, Vec3 b) { return ss_v3(a.x-b.x, a.y-b.y, a.z-b.z); }
Vec3 v3_scale(Vec3 a, double s) { return ss_v3(a.x*s, a.y*s, a.z*s); }
double v3_dot(Vec3 a, Vec3 b) { return a.x*b.x + a.y*b.y + a.z*b.z; }
Vec3 v3_cross(Vec3 a, Vec3 b) { return ss_v3(a.y*b.z-a.z*b.y, a.z*b.x-a.x*b.z, a.x*b.y-a.y*b.x); }
double v3_norm(Vec3 a) { return sqrt(v3_dot(a,a)); }
Vec3 v3_normalized(Vec3 a) { double n=v3_norm(a); return n>1e-12?v3_scale(a,1.0/n):ss_v3(0,0,0); }
...
double ss_clampd(double x, double lo, double hi) { return x<lo?lo:(x>hi?hi:x); }
